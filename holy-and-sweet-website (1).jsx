...
const SunIcon = ({ size = 72 }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none">
    ...
    {[0,30,60,90,120,150,180,210,240,270,300,330].map((a, i) => {
      ...
      return <line key={i} x1={50+inner*Math.cos(r)} y1={50+inner*Math.sin(r)} x2={50+outer*Math.cos(r)} y2={50+outer*Math.sin(r)} stroke={i%3===0?"#C07808":"#D09010"} strokeWidth={i%3===0?3:2} strokeLinecap="round"/>;
    })}
    {/* Glow halo */}
